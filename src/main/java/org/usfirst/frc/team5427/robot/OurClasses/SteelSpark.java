 ...
 * is given by the WPI libraries. It is crucial to ALWAYS use this class as
 * opposed to ever using the Talon Class from WPI. This is done to mitigate the
 * number of errors in the code, and keep a certain standard throughout the
 * program.
 * </p>
 * <p>
...
public class SteelSpark extends Spark
{
	 ...
	 * 
	 * @param channel
	 *            The PWM port that the speedcontroller is plugged into on the
	 *            roborio.
	 */
